...
function rockPaperSissors(Input) {
  ...
  if (
    (Input === "Rock") & (computer === 3) ||
    (Input === "Paper") & (computer === 1) ||
    (Input === "Sissors") & (computer === 2)
  ) {
    return "You Win";
  } else if (
    (Input === "Rock") & (computer === 2) ||
    (Input === "Paper") & (computer === 3) ||
    (Input === "Sissors") & (computer === 1)
  ) {
    return "You Loose";
  } else {
    return "Tie Game";
...
console.log(rockPaperSissors("Rock"));
...
console.log(
  countVowels("Lets test this how many can you COUNT IN THIS LETS DO IT BIG")
);
/************************************************************** Stretch **************************************************************/
